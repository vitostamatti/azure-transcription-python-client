...
def transcribe_from_single_blob(
    uri, properties: azure_transcription_client.TranscriptionProperties
):
    """
    Transcribe a single audio file located at `uri` using the settings specified in `properties`
    using the base model for the specified locale.
    """
    transcription_definition = azure_transcription_client.Transcription(
        display_name=NAME,
...
def _paginate(api: azure_transcription_client.DefaultApi, paginated_object):
    """
...
def delete_all_transcriptions(api: azure_transcription_client.DefaultApi):
    """
    ...
    for transcription in transcriptions:
        ...
        except azure_transcription_client.rest.ApiException as exc:
...
def transcribe():
    ...
    client = azure_transcription_client.ApiClient(configuration)

    # create an instance of the transcription api class
    # api = azure_transcription_client.CustomSpeechTranscriptionsApi(api_client=client)

    api = azure_transcription_client.DefaultApi(api_client=client)
    ...
    properties = azure_transcription_client.TranscriptionProperties()
    ...
    # properties.diarization = azure_transcription_client.DiarizationProperties(
    #     azure_transcription_client.DiarizationSpeakersProperties(min_count=1, max_count=5))

    # properties.language_identification = azure_transcription_client.LanguageIdentificationProperties(["en-US", "ja-JP"])
