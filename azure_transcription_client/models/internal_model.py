...
class InternalModel(object):
    ...
    """
    swagger_types = {"storage_prefix": "str", "_self": "str"}

    attribute_map = {"storage_prefix": "storagePrefix", "_self": "self"}

    def __init__(
        self, storage_prefix=None, _self=None, _configuration=None
    ):  # noqa: E501
