...
class WebHookProperties(object):
    ...
    """
    swagger_types = {"error": "EntityError", "api_version": "str", "secret": "str"}

    attribute_map = {"error": "error", "api_version": "apiVersion", "secret": "secret"}

    def __init__(
        self, error=None, api_version=None, secret=None, _configuration=None
    ):  # noqa: E501
