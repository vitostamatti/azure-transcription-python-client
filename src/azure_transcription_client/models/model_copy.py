...
class ModelCopy(object):
    ...
    """
    swagger_types = {"target_subscription_key": "str"}

    attribute_map = {"target_subscription_key": "targetSubscriptionKey"}
    ...
    def target_subscription_key(self, target_subscription_key):
        ...
        if (
            ...
            and target_subscription_key is None
        ):
            raise ValueError(
                "Invalid value for `target_subscription_key`, must not be `None`"
            )  # noqa: E501
