...
class WebHookEvents(object):
    ...
    def __init__(
        ...
        dataset_deletion=None,
        model_creation=None,
        model_processing=None,
        model_completion=None,
        model_deletion=None,
        evaluation_creation=None,
        evaluation_processing=None,
        evaluation_completion=None,
        evaluation_deletion=None,
        transcription_creation=None,
        transcription_processing=None,
        transcription_completion=None,
        transcription_deletion=None,
        endpoint_creation=None,
        endpoint_processing=None,
        endpoint_completion=None,
        endpoint_deletion=None,
        ping=None,
        challenge=None,
        _configuration=None,
    ):  # noqa: E501
